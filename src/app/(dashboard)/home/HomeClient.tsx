      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass-panel p-4 rounded-xl flex items-center justify-between">
          <div>
            ...
            <p className="text-xl font-bold text-white font-mono mt-1">৳ {formatCurrency(data.KPIs.closingStockCost).replace('৳', '')}</p>
          </div>
        ...
        <div className="glass-panel p-4 rounded-xl flex items-center justify-between">
          <div>
            ...
            <p className="text-xl font-bold text-white font-mono mt-1">৳ {formatCurrency(data.KPIs.closingStockRetail).replace('৳', '')}</p>
          </div>
        ...
        <div className="glass-panel rounded-xl overflow-hidden lg:col-span-2">
          ...
          <div className="p-4" style={{ height: 260 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.SALES_VS_PURCHASES} barGap={4}>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-surface-800">
                {data.STOCK_EXPIRY_ALERTS.map((alert) => (
